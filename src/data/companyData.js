...
export const companies = [
  {
    ...
    logo: "https://via.placeholder.com/100.png?text=Alert+Labs",
    categoryId: 7,
    details: {
      ...
      regions: ["US", "Canada"],
      risksTreatedOriginal: ["Water", "Natural Catastrophes - Flood", "Third Party Risks - Property Damage"],
  ...
  },
  {
    ...
    logo: "https://via.placeholder.com/100.png?text=Aren",
    categoryId: 2,
    details: {
      ...
      risksTreatedOriginal: ["Water - Ingress from Envelope", "Defect", "Third Party Risks", "Structural Integrity"],
  ...
  },
  {
    ...
    logo: "https://via.placeholder.com/100.png?text=Brickeye",
    categoryId: 7,
    details: {
      ...
      risksTreatedOriginal: ["Water", "Structural Integrity"],
      stakeholdersImpacted: ["General Contractors", "Owners"],
  ...
  },
  {
    ...
    logo: "https://via.placeholder.com/100.png?text=CLMA",
    categoryId: 5,
    details: {
      ...
      regions: ["US"],
      risksTreatedOriginal: ["Labor Shortage"],
  ...
  },
  {
    ...
    logo: "https://via.placeholder.com/100.png?text=Compass",
    categoryId: 5,
    details: {
      ...
      regions: ["Canada", "US"],
      risksTreatedOriginal: ["Supply Chain - Counterparty Risk"],
  ...
  },
  {
    ...
    logo: "https://via.placeholder.com/100.png?text=Druid",
    categoryId: 5,
    details: {
      ...
      risksTreatedOriginal: ["Third Party Risks - Worker Injury", "Defect - Faulty Workmanship"],
  ...
  },
  {
    ...
    logo: "https://via.placeholder.com/100.png?text=Exodigo",
    categoryId: 2,
    details: {
      ...
      regions: ["US", "Canada", "UK&I", "LATAM", "Europe", "Asia", "Pacific"],
      risksTreatedOriginal: ["Third Party Risks", "Faulty Design"],
      stakeholdersImpacted: ["Subcontractors", "General Contractors", "Owners"],
  ...
  },
  {
    ...
    logo: "https://via.placeholder.com/100.png?text=Firmus",
    categoryId: 6,
    details: {
      ...
      regions: ["US", "Canada"],
      risksTreatedOriginal: ["Defect - Faulty Design"],
      stakeholdersImpacted: ["Architects/Engineers", "General Contractors", "Owners"],
      phaseOfConstructionOriginal: ["Pre-Construction"],
      ...
      originalDigitalCategory: "Pre-construction Technologies (BIM, Spec Tech)",
      employeeCount: "11-50 employees",
  ...
  },
  {
    ...
    logo: "https://via.placeholder.com/100.png?text=InEight",
    categoryId: 1,
    details: {
      ...
      risksTreatedOriginal: ["Loss in Productivity", "Contractor Default", "Schedule/Cost Overrun", "Delay in Claims Discovery", "Design Defects", "Warranty", "Workmanship Defects", "Over and Under Payment"],
  ...
  },
  {
    ...
    logo: "https://via.placeholder.com/100.png?text=Latium",
    categoryId: 7,
    details: {
      ...
      risksTreatedOriginal: ["Water", "Fire", "Defect", "Third Party Risks", "Natural Catastrophes", "Other Physical Damage"],
      stakeholdersImpacted: ["Subcontractors", "General Contractors", "Owners"],
  ...
  },
  {
    ...
    logo: "https://via.placeholder.com/100.png?text=MegaSecur",
    categoryId: 3, // External Event Monitoring (Flood is an external event)
    details: {
  ...
  },
  {
    ...
    logo: "https://via.placeholder.com/100.png?text=MindForge",
    categoryId: 5, // Related to workforce skills & communication which impacts counterparty risk/supply chain
    details: {
  ...
  },
  {
    ...
    logo: "https://via.placeholder.com/100.png?text=OneConcern",
    categoryId: 3,
    details: {
      ...
      regions: ["US", "Japan"],
      risksTreatedOriginal: ["Natural Catastrophes", "Third Party Risks", "Other Physical Damage"],
      stakeholdersImpacted: ["Architects/Engineers", "General Contractors", "Owners"],
  ...
  },
  {
    ...
    logo: "https://via.placeholder.com/100.png?text=OpenSpace",
    categoryId: 2,
    details: {
      ...
      regions: ["US", "Canada", "UK&I", "LATAM", "Europe", "Asia", "Pacific"],
      risksTreatedOriginal: ["Defect", "Third Party Risks", "Other Physical Damage"],
      stakeholdersImpacted: ["Subcontractors", "Architects/Engineers", "General Contractors", "Owners"],
      phaseOfConstructionOriginal: ["Pre-Construction", "Construction", "Post-Construction"],
  ...
  },
  {
    ...
    logo: "https://via.placeholder.com/100.png?text=ReConstruct",
    categoryId: 2,
    details: {
      ...
      risksTreatedOriginal: ["Defects", "Third Party Risks", "Other Physical Damage"],
      stakeholdersImpacted: ["Subcontractors", "Architects/Engineers", "General Contractors", "Owners"],
  ...
  },
  {
    ...
    logo: "https://via.placeholder.com/100.png?text=Everstream",
    categoryId: 5,
    details: {
      ...
      regions: ["US", "Canada", "UK&I", "LATAM", "Europe", "Asia", "Pacific"],
      risksTreatedOriginal: ["Supply Chain"],
      stakeholdersImpacted: ["Subcontractors", "General Contractors", "Owners"],
      phaseOfConstructionOriginal: ["Planning & Design", "Pre-construction", "Construction"],
  ...
  },
  {
    ...
    categoryId: 7, // IoT Backbone - as it's a sensor technology integrated with equipment
    details: {
      ...
      risksTreatedOriginal: ["Third Party Risks"],
      stakeholdersImpacted: ["Subcontractors", "General Contractors", "Owners"],
      phaseOfConstructionOriginal: ["Construction"],
  ...
  },
  {
    ...
    categoryId: 1, // Could also fit 5 or 7, but core is PM/Ops
    details: {
      ...
      regions: ["US", "Canada", "UK&I", "LATAM", "Europe", "Asia", "Pacific"],
      risksTreatedOriginal: ["Worker Safety"],
      stakeholdersImpacted: ["Subcontractors", "Architects/Engineers", "General Contractors", "Owners"],
      phaseOfConstructionOriginal: ["Construction"],
      ...
      originalDigitalCategory: "Project Management Software",
  ...
  },
  {
    ...
    details: {
      ...
      risksTreatedOriginal: ["Worker Safety", "Defect - Faulty Workmanship", "Other Physical Damage"],
      stakeholdersImpacted: ["Subcontractors", "General Contractors", "Owners"],
      phaseOfConstructionOriginal: ["Construction"],
  ...
  },
  {
    ...
    categoryId: 7, // IoT for physical equipment control
    details: {
      ...
      risksTreatedOriginal: ["Third Party Risks", "Other Physical Damage", "Worker Safety"],
      stakeholdersImpacted: ["General Contractors", "Owners"],
      phaseOfConstructionOriginal: ["Construction"],
  ...
  },
  {
    ...
    details: {
      ...
      regions: ["US", "Canada", "UK&I", "LATAM", "Europe", "Asia", "Pacific"],
      risksTreatedOriginal: ["Natural Catastrophes", "Other Physical Damage"],
  ...
  },
  {
    ...
    details: {
      ...
      regions: ["US", "Canada", "UK&I", "LATAM", "Europe", "Asia", "Pacific"],
      risksTreatedOriginal: ["Water Damage"],
      stakeholdersImpacted: ["General Contractors", "Owners"],
      phaseOfConstructionOriginal: ["Planning & Design", "Pre-Construction", "Construction", "Post-Construction"],
  ...
  },
  {
    ...
    categoryId: 7, // Heavy on IoT/wearables
    details: {
      ...
      risksTreatedOriginal: ["Worker Safety", "Third Party Risks", "Other Physical Damage"],
      stakeholdersImpacted: ["General Contractors", "Owners"],
      phaseOfConstructionOriginal: ["Construction"],
  ...
  },
  {
    ...
    categoryId: 7, // IoT for safety systems
    details: {
      ...
      regions: ["US", "Canada", "UK&I", "LATAM", "Europe", "Asia", "Pacific"],
      risksTreatedOriginal: ["Fire Damage"],
